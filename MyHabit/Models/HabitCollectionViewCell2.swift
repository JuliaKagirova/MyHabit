//
//  HabitCollectionViewCell2.swift
//  MyHabit
//
...
class HabitCollectionViewCell2: UICollectionViewCell {
    static let id = "HabitCollectionViewCell2"
    ...
    private var placeHolder:UILabel = {
        var label = UILabel()
        label.text = "Каждый день в 07:00"
    ...
    private var colorCircle: UIButton = {
        ...
        circle.layer.borderColor = UIColor.systemGreen.cgColor
        circle.setImage(UIImage(named: "checkmark"), for: .normal)
        circle.layer.borderWidth = 1
        circle.layer.cornerRadius = 18
        circle.addTarget(HabitCollectionViewCell2.self, action: #selector(addHabit), for: .touchUpInside)
    ...
    func setupUI() {
        ...
        NSLayoutConstraint.activate([
            backgroudView.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 128),
